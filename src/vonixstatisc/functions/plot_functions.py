...
def histogram_lineplot(data: dict) -> None:
    """method to automatize line plot for period x number_of_calls"""
...
def histogram_histplot(data: dict) -> None:
    """method to automatize histogram plot for talk_secs"""
    x_plot_array = data
...
def comparison_striplot(data: dict) -> None:
    """method to automatize stripplot plot for period x relative_standard_deviation
    used after the method compareStandardModelMetrics establishes a dataframe"""
